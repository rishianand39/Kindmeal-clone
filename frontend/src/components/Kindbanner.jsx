    ...
    <Container id="container">
        <Top id="top">
            <Topleft id="topleft">
                ...
                <About>Discover new, delicious meat-free cuisines enjoyed by other compassionate food lovers. Share your interesting KindMoments, and build your own fans and followers to encourage kind, healthy meals.</About>
                <About>Download our mobile app to easily showcase your masterpieces and interact with food lovers.</About>
            ...
            <Topright id="topright">
                <Box>
                    ...
                    <About>Interesting food or restaurant? Share with 1000s of food lovers!</About>
                    <Button >Share</Button>
                </Box>
            </Topright>
